...
<head>
    ...
    <!-- Using Laravel's asset() function for the CSS file -->
    <link rel="stylesheet" href="{{ asset('css/coaches_profile.css') }}">
</head>
<body>
    <!-- Top Navbar with Back Button -->
    <div class="navbar">
        <!-- Using Laravel's url() function for the navigation link -->
        <a href="{{ url('/') }}#coaches" class="back-btn">Back to Coaches</a>
    </div>
    ...
    <div class="portfolio-container">
        ...
        <div class="profile-header">
            <!-- Using Laravel's asset() function for the image -->
            <img src="{{ asset('images/coaches/fitnesse1.jpg') }}" alt="John Doe" class="profile-image">
        ...
        <section class="schedule-section">
            ...
            <!-- Using Laravel's url() function for the booking page -->
            <a href="{{ url('/payment') }}" class="book-btn">Book Coach</a>
        </section>
    </div>
</body>
</html>
