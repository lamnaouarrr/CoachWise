...
<body>
    ...
    <div class="navbar">
        <!-- Using Laravel's asset() function for navigation links -->
    ...
    <div class="portfolio-container">
        ...
        <div class="profile-header">
            ...
            <img src="{{ asset('images/coaches/box1.jpg') }}" alt="Mohammed RABII" class="profile-image">
            <div class="profile-info">
                <h1>Mohammed RABII</h1>
        ...
        <section class="bio-section">
            <h3>About Mohammed</h3>
            <p>
                Mohammed RABII has over 10 years of experience in the fitness industry. His passion lies in transforming lives through fitness, focusing on strength training, bodybuilding, and healthy lifestyle changes. Mohammed believes in a holistic approach that empowers clients not only physically but also mentally.
            </p>
        </section>
        ...
        <section class="schedule-section">
            ...
            <!-- Using Laravel's asset() function for the "Book Coach" button link -->
